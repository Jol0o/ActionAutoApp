...
function StatCard({
  ...
  return (
    <div
      className={`flex-1 min-w-27.5unded-lg border bg-card px-4 py-3 ${accent}`}
    >
  ...
  return (
    <div className="space-y-5">
      <div className="flex flex-wrap gap-2.5">
        ...
        <StatCard
          label="In Transit"
          value={summary.inRoute + summary.dispatched}
