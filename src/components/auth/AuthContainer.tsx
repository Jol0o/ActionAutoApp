...
export function AuthContainer({ initialMode }: { initialMode?: "signin" | "signup" }) {
    ...
    return (
        <div className="min-h-screen w-full bg-[#050505] flex items-center justify-center p-0 md:p-6 lg:p-12 overflow-hidden font-sans">
