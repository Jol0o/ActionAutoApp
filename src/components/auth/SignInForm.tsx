        ...
        <div className="w-full space-y-8">
            <div className="space-y-3">
                ...
                <p className="text-zinc-500 text-lg font-light leading-relaxed">
                    Today is a new day. It&apos;s your day. You shape it. <br className="hidden md:block" />Sign in to start managing your projects.
                </p>
            </div>
            ...
            <div className="relative py-4">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                    <span className="bg-[#0a0a0a] px-4 text-zinc-500 font-medium tracking-widest">Or</span>
                </div>
            </div>
