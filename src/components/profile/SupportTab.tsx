    ...
    return (
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <Card className="p-0 shadow-xl border border-cyan-100 dark:border-cyan-900 overflow-hidden hover-lift">
                ...
                <CardHeader className="py-4 bg-gradient-to-br from-cyan-50 to-blue-50/50 dark:from-gray-900 dark:to-gray-800 border-b border-cyan-100 dark:border-cyan-900">
            ...
            <Card className="p-0 shadow-xl border border-red-200 dark:border-red-900 md:col-span-2 overflow-hidden hover-lift">
                ...
                <CardHeader className="py-4 bg-gradient-to-br from-red-50 to-orange-50/50 dark:from-gray-900 dark:to-gray-800 border-b border-red-200 dark:border-red-900">
