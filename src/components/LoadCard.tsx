...
export function LoadCard({ load, onDelete, isDeleting }: LoadCardProps) {
  ...
  return (
    <Link href={"/transportation/load/" + load._id}>
          ...
          <div className="p-4 sm:p-5 space-y-3.5">
            ...
            <div className="flex flex-wrap items-center gap-2 justify-between">
              <div className="flex flex-wrap items-center gap-1.5">
                ...
                <span className={`inline-flex items-center gap-0.5 px-2 py-0.5 rounded-full text-[10px] font-medium border ${isLoadBoard
