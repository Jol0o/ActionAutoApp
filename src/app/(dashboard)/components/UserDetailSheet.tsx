...
export function UserDetailSheet({ user, open, onOpenChange }: UserDetailSheetProps) {
  ...
  return (
    <Sheet open={open} onOpenChange={onOpenChange}>
      <SheetContent className="w-full sm:max-w-md border-l border-border/40 bg-background/95 backdrop-blur-xl p-0 overflow-y-auto">
        {/* Header Section */}
        <div className="relative h-32 bg-gradient-to-br from-primary/20 via-primary/5 to-transparent border-b border-primary/10">
        ...
        <div className="pt-14 px-6 pb-8 space-y-8">
          ...
          <div>
            <div className="flex items-center justify-between">
              ...
              <Badge variant="secondary" className="bg-emerald-500/10 text-emerald-500 border-none font-black uppercase text-[10px]">
                Active Now
              </Badge>
            </div>
          ...
          <div className="space-y-4 pt-4 border-t border-border/40">
            <div className="flex items-center gap-3 text-sm">
              ...
              <div>
                ...
                <p className="font-bold">{user.name.toLowerCase().replace(' ', '.')}@actionauto.com</p>
              </div>
            </div>
            <div className="flex items-center gap-3 text-sm">
              <div className="size-8 rounded-lg bg-muted flex items-center justify-center shrink-0">
